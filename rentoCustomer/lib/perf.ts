// Lightweight per-request stage timing, matching the "[API] stage: Nms" format used
// across the hot endpoints (booking creation, payment submission, etc). Deliberately
// simple — no external dependency, no persistence — this is for reading in server logs
// during development/debugging and for spotting regressions, not a metrics pipeline.
